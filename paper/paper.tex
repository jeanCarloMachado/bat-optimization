...
\label{Pseudo Code}
\text{Parameters:} n, \alpha\, \lambda\\
\text{Initialize bats assycrously}\\
\text{synchronize threads}\\
\text{Evaluate fitness bats}\\
\text{Selects best}\\
\text{\textbf{while} stop criteria false \textbf{do}}\\
...
\begin{table}[!t]
    ...
    \hline
        \bf Name & Fitness C & Total C & Fitness G & Total G & Speedup\\
    \hline
...
individuals. The advantages of the algorithm may be tested against a CPU
...
achieved by a great population size.
