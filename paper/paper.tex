...
intelligence algorithms, define: "they are compounded by a distributed
...
The rest of the paper is organized as following: Section 1 gives a overview of cuda and its components. Section 2 studies 
the bat meta-heuristic, it's design and details. Section 3 details the experiments performed. Section 4 analyses the results and concludes.
