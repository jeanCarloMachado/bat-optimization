...
void test_copy_bat(void)
{
    ...
    from = (struct bat *) malloc(sizeof(struct bat));
    to = (struct bat *) malloc(sizeof(struct bat));

    from->position = (double *) malloc(sizeof(double) * 4);
    to->position = (double *) malloc(sizeof(double) * 4);
